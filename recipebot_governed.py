...
recipe_team = Team(
    ...
    instructions=[
        ...
        "2. Riceverai una descrizione testuale dal RecipeWorker.",
        "3. Estrai dalla sua risposta i campi dello schema RecipeRecommendation.",
        "4. Non aggiungere informazioni che il worker non ha fornito.",
        "5. Non chiamare tool: il worker ha gia' fatto il lavoro pesante.",
    ],
    output_schema=RecipeRecommendation,
    use_json_mode=True,
    ...
    post_hooks=[validate_recipe_quality],
)
